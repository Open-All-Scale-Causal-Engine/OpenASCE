...
from openasce.extension.debias import DRDebiasModel
...
def test_model():
    ...
    cvr_scores = tf.sigmoid(result["dr_logits"])
    from sklearn.metrics import roc_auc_score

    cvr_auc = roc_auc_score(result["cvr_labels"], cvr_scores)
