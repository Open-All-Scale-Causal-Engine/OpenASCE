...
from openasce.extension.debias import DICEDebiasModel
...
def get_dataset():
    ...
    def pack_features_vector(features, labels):
        mask = tf.cast(features["T"], tf.int32)
